...
@section('content')
    ...
    <div class="template">
        <div class="box">
            ...
            <ul>
                <li><a href="/" target="_blank"><img src="{{asset('resources/views/home/images/01.jpg')}}"></a><span>仿新浪博客风格·梅——古典个人博客模板</span>
                </li>
                <li><a href="/" target="_blank"><img src="{{asset('resources/views/home/images/02.jpg')}}"></a><span>黑色质感时间轴html5个人博客模板</span>
                </li>
                <li><a href="/" target="_blank"><img src="{{asset('resources/views/home/images/03.jpg')}}"></a><span>Green绿色小清新的夏天-个人博客模板</span>
                </li>
                <li><a href="/" target="_blank"><img src="{{asset('resources/views/home/images/04.jpg')}}"></a><span>女生清新个人博客网站模板</span>
                </li>
                <li><a href="/" target="_blank"><img src="{{asset('resources/views/home/images/02.jpg')}}"></a><span>黑色质感时间轴html5个人博客模板</span>
                </li>
                <li><a href="/" target="_blank"><img src="{{asset('resources/views/home/images/03.jpg')}}"></a><span>Green绿色小清新的夏天-个人博客模板</span>
    ...
    <article>
        ...
        <div class="bloglist left">
            ...
            <p class="dateview"><span>2013-11-04</span><span>作者：后盾</span><span>个人博客：[<a
